...
public class LoyaltyCardStepDefinitions {
    ...
    private LoyaltyCardProgram cardProgram;
    private LoyaltyProgramMember member;
    ...
    public void the_following_drink_categories(List<Map<String, String>> drinkCategoryInfo) {
        ...
        if (cardProgram == null) {
            cardProgram = new LoyaltyCardProgram();
            drinkCategoryInfo.stream().forEach(
                    drinkCategory -> {
                        ...
                        cardProgram.addMenuItem(drink, category, points);
                    }
            );
        }
    }
